...
//            rectShape.bounds = cell.lblGrph1.frame
//            rectShape.position = cell.lblGrph1.center
//            rectShape.path = UIBezierPath(roundedRect: cell.lblGrph1.bounds, byRoundingCorners: [.topRight , .bottomRight], cornerRadii: CGSize(width: 20, height: 20)).cgPath
//
//            cell.lblGrph1.layer.backgroundColor = UIColor.green.cgColor
            //Here I'm masking the textView's layer with rectShape layer
//            cell.lblGrph1.layer.mask = rectShape
...
//            rectShape2.bounds = cell.lblGrph2.frame
//            rectShape2.position = cell.lblGrph2.center
//            rectShape2.path = UIBezierPath(roundedRect: cell.lblGrph2.bounds, byRoundingCorners: [.topLeft , .bottomLeft], cornerRadii: CGSize(width: 20, height: 20)).cgPath
//
//            cell.lblGrph2.layer.backgroundColor = UIColor.green.cgColor
//            //Here I'm masking the textView's layer with rectShape2 layer
//            cell.lblGrph2.layer.mask = rectShape2
            
            
            
            
            
//            cell.lblMiddle1.text = "xyz1"
//            cell.lblMiddle2.text = "xyz2"
//            cell.lblMiddle3.text = "xyz3"
//            cell.lblMiddle4.text = "xyz4"
            
            DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(2), execute: {
                cell.lblGrph1.roundCorners(corners: [.topRight,.bottomRight], radius:cell.lblGrph1.frame.size.height/2)
                    
                cell.lblGrph2.roundCorners(corners: [.topLeft,.bottomLeft], radius:cell.lblGrph2.frame.size.height/2)
                
                cell.lblGrph4.roundCorners(corners: [.topLeft,.bottomLeft], radius:cell.lblGrph4.frame.size.height/2)
                
                cell.lblGrph5.roundCorners(corners: [.topRight,.bottomRight], radius:cell.lblGrph5.frame.size.height/2)
                
                cell.lblGrph7.roundCorners(corners: [.topLeft,.bottomLeft], radius:cell.lblGrph7.frame.size.height/2)
                
                cell.lblGrph8.roundCorners(corners: [.topRight,.bottomRight], radius:cell.lblGrph8.frame.size.height/2)
                    
                cell.lblMiddle4.roundCorners(corners: [.topLeft,.bottomLeft], radius:cell.lblMiddle4.frame.size.height/2)
                    
                cell.lblMiddle3.roundCorners(corners: [.topRight,.bottomRight], radius:cell.lblMiddle3.frame.size.height/2)
                    
                cell.lblMiddle6.roundCorners(corners: [.topLeft,.bottomLeft], radius:cell.lblMiddle6.frame.size.height/2)
                    
                cell.lblMiddle5.roundCorners(corners: [.topRight,.bottomRight], radius:cell.lblMiddle5.frame.size.height/2)
                    
                    cell.lblGrph1.gradientYellow()
                    cell.lblGrph2.gradientYellow2()
                    cell.lblGrph4.gradientYellow2()
                    cell.lblGrph5.gradientYellow()
                    cell.lblGrph7.gradientYellow2()
                    cell.lblGrph8.gradientYellow()
                    cell.lblGrph3.gradientYellow()
                    cell.lblGrph6.gradientYellow()
            })
            
            if((self.dictBriefReport.value(forKey: "statics")) != nil){
                let dictStatics = self.dictBriefReport.value(forKey: "statics") as? NSDictionary ?? [:]
                let dictMe = dictStatics.value(forKey: "kamu") as? NSDictionary ?? [:]
                    print("dictMe: ",dictMe)
                
                let strStaticVal = (dictMe.value(forKey: "syllabus_coverage")) as? Double ?? 0.0
                let strPerformanceVal = (dictMe.value(forKey: "progress_nilai")) as? Double ?? 0.0
                print("dictMe2: ",CGFloat(strStaticVal), CGFloat(strPerformanceVal))
                cell.lblMeStatics.text = "\(strStaticVal)%"
                cell.lblMePerformance.text = "\(strPerformanceVal)%"
                cell.meStatsticsWidth.constant = CGFloat(strStaticVal)
                cell.mePerformanceWidth.constant = CGFloat(strPerformanceVal)
                
                
                
                let dictTopUser = dictStatics.value(forKey: "rata_rata_user") as? NSDictionary ?? [:]
                    let strStatisticVal = (dictTopUser.value(forKey: "syllabus_coverage")) as? Double ?? 0.0
                    let strPerformanceVal2 = (dictTopUser.value(forKey: "progress_nilai")) as? Double ?? 0.0
//                    print("dictAvgUser: ",strStatisticVal)
                    print("dictTopUser: ",dictTopUser)
                    print("dictTopUser: ",CGFloat(strStatisticVal), CGFloat(strPerformanceVal2))
                
                cell.lbltopUserStatics.text = "\(strStatisticVal)%"
                cell.lbltopUserPerformance.text = "\(strPerformanceVal2)%"
                cell.topUserStatisticsWidth.constant = CGFloat(strStatisticVal)
                cell.topUserPerformanceWidth.constant = CGFloat(strPerformanceVal2)
                
                
                let dictAvgUser = dictStatics.value(forKey: "user_terabaik") as? NSDictionary ?? [:]
                    let strStatisticVal2 = (dictAvgUser.value(forKey: "syllabus_coverage")) as? Double ?? 0.0
                    let strPerformanceVal3 = (dictAvgUser.value(forKey: "progress_nilai")) as? Double ?? 0.0
                    print("dictAvgUser: ",dictAvgUser)
                    print("dictAvgUser: ",CGFloat(strStatisticVal2), CGFloat(strPerformanceVal3))
                
                cell.lblaverageUserStatics.text = "\(strStatisticVal2)%"
                cell.lblaverageUserPerformance.text = "\(strPerformanceVal3)%"
                cell.averageUserStatisticsWidth.constant = CGFloat(strStatisticVal2)
                cell.averageUserPerformanceWidth.constant = CGFloat(strPerformanceVal3)
                }
