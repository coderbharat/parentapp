...
class homeTVCell: UITableViewCell {
    ...
    @IBOutlet weak var lblMiddle5: UILabel!
    
    @IBOutlet weak var lblMiddle6: UILabel!
    ...
    @IBOutlet weak var meStatsticsWidth: NSLayoutConstraint!
    @IBOutlet weak var mePerformanceWidth: NSLayoutConstraint!
    @IBOutlet weak var topUserStatisticsWidth: NSLayoutConstraint!
    @IBOutlet weak var topUserPerformanceWidth: NSLayoutConstraint!
    @IBOutlet weak var averageUserStatisticsWidth: NSLayoutConstraint!
    @IBOutlet weak var averageUserPerformanceWidth: NSLayoutConstraint!
    
    @IBOutlet weak var lblMeStatics: UILabel!
    @IBOutlet weak var lblMePerformance: UILabel!
    
    @IBOutlet weak var lbltopUserStatics: UILabel!
    @IBOutlet weak var lbltopUserPerformance: UILabel!
    
    @IBOutlet weak var lblaverageUserStatics: UILabel!
    @IBOutlet weak var lblaverageUserPerformance: UILabel!
